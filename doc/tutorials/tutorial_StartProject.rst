...
Assume that you want to create a package called :code:`otter`. You can
do this by running the following command in your terminal:

.. code-block:: bash

    pkgdeveloper starter -a "'Your Name'" -n "'otter'" -v

This will create a directory called :code:`otter` in your current
...
.. code-block:: bash
    ...
    otter -h    # shows a description of the package 
    otter doc   # opens a html documentation in your browser
    otter path  # shows the absolute path of the package
...
:code:`src/otter` and add this script there:
...
.. code-block:: python
    ...
    from otter.coolscript import coolfunction
...
.. code-block:: bash
    ...
    pkgdeveloper generate_main -n otter -v
    otter coolfunction "Klasse!" --intigers_as_well "3" --even_lists "[1,2,3]"
...
.. code-block:: bash
    ...
    pkgdeveloper add_python_doc -n otter -v
...
then move to :code:`src/otter/` and add the script as you prefer, but
...
.. code-block:: bash
    ...
    pkgdeveloper empty_sh -n coolbash -p otter -v
...
.. code-block:: bash
    ...
    pkgdeveloper generate_main -n otter -v
    otter coolbash -h  # show the help message
    otter coolbash -path  # show the path of the file
    # Open the file and see that the template comes with the flags -d, -c and
    # -v. Run the following command to see the differences
    otter coolbash -d "input to variable"
    otter coolbash -d "input to variable" -v
    otter coolbash -d "input to variable" -c -v
...
.. code-block:: bash
    ...
    pkgdeveloper doc_modules -n otter -v
    otter doc  # opens the html documentation in your browser

In this way all you scripts are well documented and you can reference them in
different rst files. For example, add \:bashscript:`otter.coolbash`
and \:func:`otter.coolscript.coolfunction` in your index.rst file. and run the
last commands.